...
serve(async (req) => {
  ...
  try {
    ...
    // Call ElizaOS Cloud video generation API
    ...
    console.log('Video API response:', respText.slice(0, 500));
    ...
    // Return video URL - handle multiple response formats
    ...
    return new Response(
      JSON.stringify({ videoUrl, raw: data }),
