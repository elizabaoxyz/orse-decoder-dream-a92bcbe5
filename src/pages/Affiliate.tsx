    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="border-b border-border">
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <div className="bg-card border border-border p-8 max-w-md mx-auto">
            <div className="mb-6">
      ...
      <section className="border-b border-border">
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <Accordion type="single" collapsible className="space-y-2">
            <AccordionItem value="limit" className="border border-border bg-card px-4">
            ...
            <AccordionItem value="minimum" className="border border-border bg-card px-4">
              <AccordionTrigger className="text-left">
            ...
            <AccordionItem value="advertise" className="border border-border bg-card px-4">
              <AccordionTrigger className="text-left">
            ...
            <AccordionItem value="existing" className="border border-border bg-card px-4">
              <AccordionTrigger className="text-left">
            ...
            <AccordionItem value="cancelled" className="border border-border bg-card px-4">
              <AccordionTrigger className="text-left">
          ...
          {step === 1 ? (
            <>
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-8">
                <div className="flex items-center gap-2 bg-card border border-border px-3 py-2 text-sm">
