...
const resources = {
  en: {
    translation: {
      ...
      builderApiIntegration: 'Polymarket CLOB Builder API Integration',
      overview: 'Overview',
      markets: 'Markets',
      ...
      users: 'Users',
      recentBuilderTrades: 'Recent Builder Trades',
      noTradesYet: 'No trades yet',
      tradesWillAppear: 'Trades attributed to your builder will appear here',
      selectToken: 'Select Token',
      selectMarketFirst: 'Select a market from the Markets tab first',
      selectMarketToViewOrderBook: 'Select a market to view order book',
  ...
  zh: {
    translation: {
      ...
      // Builder Dashboard
      builderDashboard: 'Builder 控制台',
      builderApiIntegration: 'Polymarket CLOB Builder API 集成',
      overview: '概览',
      markets: '市场',
      orderBook: '订单簿',
      disconnected: '已断开',
      ...
      feesEarned: '赚取费用',
      users: '用户',
      recentBuilderTrades: '最近 Builder 交易',
      noTradesYet: '暂无交易',
      tradesWillAppear: '通过您的 Builder 进行的交易将显示在这里',
      selectToken: '选择代币',
      selectMarketFirst: '请先从市场标签页选择一个市场',
      selectMarketToViewOrderBook: '选择一个市场查看订单簿',
      ...
      endsTomorrow: '明天结束',
      daysLeft: '天后结束',
      adjustFilters: '请调整搜索条件或筛选器',
      minOrder: '最小订单',
      tick: '最小价格变动',
      lastPrice: '最新价格',
      spread: '价差',
      tickSize: '最小变动',
      noOrderBookData: '无订单簿数据',
      asksSells: '卖单',
      bidsBuys: '买单',
      orders: '个订单',
      price: '价格',
  ...
  vi: {
    translation: {
      ...
      // Builder Dashboard
      builderDashboard: 'Bảng Điều Khiển Builder',
      builderApiIntegration: 'Tích hợp Polymarket CLOB Builder API',
      overview: 'Tổng quan',
      markets: 'Thị trường',
      orderBook: 'Sổ lệnh',
      ...
      volumeUsdc: 'Khối lượng (USDC)',
      feesEarned: 'Phí thu được',
      users: 'Người dùng',
      recentBuilderTrades: 'Giao dịch Builder gần đây',
      noTradesYet: 'Chưa có giao dịch',
      tradesWillAppear: 'Giao dịch qua builder của bạn sẽ hiển thị ở đây',
      selectToken: 'Chọn Token',
      selectMarketFirst: 'Chọn thị trường từ tab Thị trường trước',
      selectMarketToViewOrderBook: 'Chọn thị trường để xem sổ lệnh',
      acceptingOrders: 'đang nhận lệnh',
      resolved: 'Đã giải quyết',
      noEndDate: 'Không có ngày kết thúc',
      ended: 'Đã kết thúc',
      endsToday: 'Kết thúc hôm nay',
      endsTomorrow: 'Kết thúc ngày mai',
  ...
  th: {
    translation: {
      ...
      // Builder Dashboard
      builderDashboard: 'แดชบอร์ด Builder',
      builderApiIntegration: 'การเชื่อมต่อ Polymarket CLOB Builder API',
      overview: 'ภาพรวม',
      markets: 'ตลาด',
      ...
      apiConfiguration: 'การตั้งค่า API',
      endpoint: 'Endpoint',
      chainId: 'Chain ID',
      polygon: 'Polygon',
      builderApi: 'Builder API',
      ...
      volumeUsdc: 'ปริมาณ (USDC)',
      feesEarned: 'ค่าธรรมเนียมที่ได้รับ',
      users: 'ผู้ใช้',
      recentBuilderTrades: 'การซื้อขาย Builder ล่าสุด',
      noTradesYet: 'ยังไม่มีการซื้อขาย',
      tradesWillAppear: 'การซื้อขายผ่าน builder ของคุณจะแสดงที่นี่',
      selectToken: 'เลือก Token',
      selectMarketFirst: 'เลือกตลาดจากแท็บตลาดก่อน',
      selectMarketToViewOrderBook: 'เลือกตลาดเพื่อดูสมุดคำสั่ง',
      acceptingOrders: 'รับคำสั่งซื้อ',
      resolved: 'แก้ไขแล้ว',
      noEndDate: 'ไม่มีวันสิ้นสุด',
      ended: 'สิ้นสุดแล้ว',
      endsToday: 'สิ้นสุดวันนี้',
      endsTomorrow: 'สิ้นสุดพรุ่งนี้',
      daysLeft: 'วันเหลือ',
      adjustFilters: 'ลองปรับการค้นหาหรือตัวกรอง',
      minOrder: 'คำสั่งขั้นต่ำ',
      tick: 'Tick',
      lastPrice: 'ราคาล่าสุด',
      spread: 'Spread',
      tickSize: 'Tick Size',
      noOrderBookData: 'ไม่มีข้อมูลสมุดคำสั่ง',
      asksSells: 'ขาย',
      bidsBuys: 'ซื้อ',
      orders: 'คำสั่ง',
      price: 'ราคา',
